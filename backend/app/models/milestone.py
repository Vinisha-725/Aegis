"""
Milestone model — a deliverable within a Project.

Each Milestone has acceptance criteria, a deadline, and goes through
a verification lifecycle culminating in escrow release.
"""
...
class MilestoneStatus(str, enum.Enum):
    ...
    APPROVED = "approved"         # Consensus passed — escrow released
    REJECTED = "rejected"         # Consensus failed
    DISPUTED = "disputed"         # Under appeal (Nemesis — future)
...
class Milestone(TimestampMixin, Base):
    ...
    payment_token: Mapped[str] = mapped_column(String(10), default="USDC", nullable=False)
