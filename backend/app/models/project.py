"""
Project model — a contract between a client and a developer.

A Project groups Milestones, links to a Repository,
and tracks overall status.
"""
...
class Project(TimestampMixin, Base):
    """A client–developer contract containing milestones."""
    ...
    developer: Mapped[User | None] = relationship(
        "User",
        back_populates="developer_projects",
